<?php
    if(!isset($_COOKIE['cat']) && !isset($_COOKIE['last_view'])) {
        ...
        setcookie('last_view', 'Sword Art Online', time()+86400*14, '/'); //anime name
    } else {
        unset($_COOKIE['cat']);
...
<div class="contents">
    ...
    <h1 class="anime-title">Sword Art Online :</h1><br><br><br>
    ...
    <center><div class="ep-lst">
        ...
        <div class="saison">
            ...
            <?php
                ...
                $sql = "SELECT * FROM saoiframe WHERE id BETWEEN 1 AND 25";
                $res = mysqli_query($conn, $sql);

                while($row = mysqli_fetch_assoc($res)) {
                    echo
                        "
                        <a href='watch/sao.php?ep=".$row['id']."'><button class='ep-btn'>Episode ".$row['id']."</button></a>
                        ";
                }
