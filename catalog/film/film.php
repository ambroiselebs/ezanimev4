...
<body>
    ...
    <div class="contents">
        ...
        <?php
            ...
            if (filter_var($_GET['film'], FILTER_VALIDATE_INT) === false) {
                header('Location: https://www.youtube.com/watch?v=dQw4w9WgXcQ');
            } else {
            if(htmlspecialchars(htmlspecialchars(isset($_GET['film']))))
            {
                $ep = $_GET['film'];

                $sql = "SELECT * FROM films WHERE id='$ep'";
        ...
        ?>
                ...
                <div id="hide_btn-watch" class="btn_list-show_hide">
                    <a href="../../film.php"><i class="fas fa-undo-alt fa-2x return-btn" id="returnBTN"></i></a>
