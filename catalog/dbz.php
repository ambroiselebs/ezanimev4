...
<div class="contents">
    ...
    <h1 class="anime-title">Dragon Ball Z :</h1><br><br><br>
    ...
    <center><div class="ep-lst">
        ...
        <div class="saison">
            ...
            $sql = "SELECT * FROM dbziframe WHERE id BETWEEN 1 AND 39";
            $res = mysqli_query($conn, $sql);

            while($row = mysqli_fetch_assoc($res)) {
                echo
                    "
                    <a href='watch/dbz.php?ep=".$row['id']."'><button class='ep-btn'>Episode ".$row['id']."</button></a>
                    ";
            }
        ...
        <div class="saison">
            ...
            $sql = "SELECT * FROM dbziframe WHERE id BETWEEN 40 AND 74";
            $res = mysqli_query($conn, $sql);
        ...
        <div class="saison">
            ...
            $sql = "SELECT * FROM dbziframe WHERE id BETWEEN 75 AND 107";
            $res = mysqli_query($conn, $sql);
