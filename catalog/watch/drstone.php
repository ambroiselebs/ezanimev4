...
<div class="contents">
    ...
    if (filter_var($_GET['ep'], FILTER_VALIDATE_INT) === false) {
        ...
        if(htmlspecialchars(htmlspecialchars(isset($_GET['ep']))))
        {
            ...
            $sql = "SELECT * FROM drstoneiframe WHERE id='$ep'";
            ...
            <div id="hide_btn-watch" class="btn_list-show_hide">
                <a href="../drstone.php"><i class="fas fa-undo-alt fa-2x return-btn" id="returnBTN"></i></a>
                <?php echo "<h3 class='h-ep_number'>Episode : ".$ep."</h3>"; ?>
                <div class="ep-list_next">
                    <?php echo "<a href='drstone.php?ep=".$previousep." ' ><button class='before_ep'>Episode précédent</button></a>" ?>
                    <?php echo "<a href='drstone.php?ep=".$epnext."' ><button class='next_ep'>Episode suivant</button></a>" ?>
                    <br>
