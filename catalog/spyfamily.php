...
<div class="contents">
    ...
    <h1 class="anime-title">Spy x Family</h1><br><br>

    <center><div class="ep-lst">

        <div class="saison">

        <h2>Saison 1 (vostfr)</h2><br>

            <?php

                $sql = "SELECT * FROM spyxfamily WHERE id > 0";
                $res = mysqli_query($conn, $sql);

                while($row = mysqli_fetch_assoc($res)) {
                    echo
                        "
                        <a href='watch/spyxfamilyu.php?ep=".$row['id']."'><button class='ep-btn'>Episode ".$row['id']."</button></a>
                        ";
                }
