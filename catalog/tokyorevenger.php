<?php
    if(!isset($_COOKIE['cat']) && !isset($_COOKIE['last_view'])) {
        ...
        setcookie('last_view', 'Tokyo Revenger', time()+86400*14, '/'); //anime name
    } else {
        unset($_COOKIE['cat']);
...
<div class="contents">
    ...
    <h1 class="anime-title">Tokyo Revengers :</h1><br><br><br>
    ...
    <center><div class="ep-lst">
        ...
        <?php
            ...
            $sql = "SELECT * FROM tokyoghouliframe WHERE id BETWEEN 1 AND 24 ";
            $res = mysqli_query($conn, $sql);

            while($row = mysqli_fetch_assoc($res)) {
                echo
                    "
                    <a href='watch/tokyorevenger.php?ep=".$row['id']."'><button class='ep-btn'>Episode ".$row['id']."</button></a>
                    ";
            }
